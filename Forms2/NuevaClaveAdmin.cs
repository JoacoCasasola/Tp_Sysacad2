...
namespace Forms2
{
    public partial class NuevaClaveAdmin : Form
    {

        public NuevaClaveAdmin()
        {
            InitializeComponent();
        ...
        private void CambiarClave(string claveActual, string newClave)
        {
            try
            {
                string json = File.ReadAllText("C:\\Users\\Admin\\source\\repos\\libreriaClases\\Datos\\Administradores.json");
                ...
                if (persona != null)
                {
                    ...
                    File.WriteAllText("C:\\Users\\Admin\\source\\repos\\libreriaClases\\Datos\\Administradores.json", jsonArray.ToString());
