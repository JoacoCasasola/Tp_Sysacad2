...
namespace Forms2
{
    public partial class NuevaClaveProfesor : Form
    {
        public NuevaClaveProfesor()
        {
            InitializeComponent();
        }
        ...
        private void CambiarClave(string claveActual, string newClave)
        {
            try
            {
                ...
                if (persona != null)
                {
                    ...
                    File.WriteAllText("C:\\Users\\Admin\\source\\repos\\libreriaClases\\Datos\\Profesores.json", jsonArray.ToString());
