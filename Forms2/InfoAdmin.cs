...
namespace Forms2
{
    public partial class InfoAdmin : Form
    {
        ...
        {
            if (Validadores.VerificarUnicidad("ID", "C:\\Users\\Admin\\source\\repos\\libreriaClases\\Datos\\Administradores.json",id))
            {
                try
                {
        ...
        {
            NuevaClaveAdmin nuevaClave = new NuevaClaveAdmin();
